        ...
        <section id="events" className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-12">
              <Link to="/events" className="bg-indigo-100 text-indigo-700 py-2 px-6 rounded-full font-medium hover:bg-indigo-200 inline-flex items-center">
