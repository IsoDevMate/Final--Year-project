...
//   const { eventId } = useParams<{ eventId: string }>();
  ...
  const [currentTag, setCurrentTag] = useState('');
    ...
    const fetchEvents = async () => {
      try {
        ...
        const response = await axios.get('https://final-year-project-77pa.onrender.com/api/v1/events');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('https://final-year-project-77pa.onrender.com/api/v1/sessions/create', submissionData);
